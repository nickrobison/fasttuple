...
public abstract class TupleSchema implements Loader<FastTuple>, Destroyer<FastTuple> {
    ...
    public static class Builder {
        ...
        /**
         * Adds a field name and type to the schema. Field names end up as both method names and field names in the
         * generated class, therefore they have the same restrictions on allowable characters. Passing in an illegal
         * name will cause a CompileException during the call to build.
         *
         * @param fieldName
         *            - Name of field
         * @param fieldType
         *            - {@link Class} type of field
         * @return - {@link Builder}
         */
        ...
        /**
         * The generated FastTuple subclass will implement the passed in interface. FastTuple's produced from this
         * schema can then be cast to the interface type, for type safe invocation of the desired methods.
         *
         * @param iface
         *            - {@link Class} interface to implement
         * @return - {@link Builder}
         */
        ...
        /**
         * Sets the initial size for each thread local tuple pool. The total number of tuples that will be allocated can
         * be found by multiplying this number by the number of threads that will be checking tuples out of the pool.
         *
         * @param poolSize
         *            - The size to generate specified in number of tuples.
         * @return - {@link Builder}
         */
        ...
        /**
         * Specifies that the tuple pool should allocate more tuples when it becomes exhausted. Otherwise, an exhausted
         * pool will throw an IllegalStateException.
         *
         * @return - {@link Builder}
         */
    ...
    public boolean equals(Object other) {
        if (other instanceof TupleSchema) {
            ...
            return Arrays.equals(fieldNames, o.fieldNames) && Arrays.equals(fieldTypes, o.fieldTypes);
        }
        return false;
    }
     ...
     *             if the field name is not found in the schema
     */
    ...
    /**
     * Allocates a new typed tuple, completely separate from any pooling. Use care to call
     * {@link Builder#implementInterface(Class)} before using this method
     *
     * @param clazz
     *            - {@link Class} implemented by the Tuple
     * @param <T>
     *            - {@link T} type parameter
    ...
    /**
     * Allocates an array of tuples. This method will try to ensure that tuples get allocated in adjacent memory,
     * however with the heap based allocation this is not guaranteed.
     *
     * @param size
     ...
     *
     * @param tuple
     *            - {@link FastTuple} cast to type {@link T}
     * @param <T>
     *            - {@link T} underlying class implemented by tuples
     */
     ...
     *
     * @param ary
     *            - Array of {@link FastTuple} to deallocate
     */
     ...
     *
     * @param ary
     *            - Array of typed {@link FastTuple} to deallocate
     * @param <T>
     *            - {@link T} underlying class implemented by tuples
     */
