...
public class DirectTupleSchemaTest {
    ...
    public void layoutTest() throws Exception {
        DirectTupleSchema schema = TupleSchema.builder().addField("aByte", Byte.TYPE).addField("aChar", Character.TYPE)
                ...
                .addField("aLong", Long.TYPE).addField("aDouble", Double.TYPE).directMemory().build();
    ...
    public void paddingTest() throws Exception {
        DirectTupleSchema schema = TupleSchema.builder().addField("aByte", Byte.TYPE).addField("aChar", Character.TYPE)
                .addField("aInt", Integer.TYPE).addField("aShort", Short.TYPE).addField("aFloat", Float.TYPE)
                .addField("aLong", Long.TYPE).addField("aDouble", Double.TYPE).directMemory().padToWordSize(64).build();
